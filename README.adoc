...
**Pour SL**: Tu entends par interface, un sous mode de dialogue ?
* L'état de la partie devra pouvoir être sauvegardée et rechargée à tout moment. **Pour SL**: On impose un format comme json ? Si texte demande plus de boulot et Serialisable trop direct
...
https://jellepelgrims.com/posts/roguelike_java[Writing a roguelike in Java] **Pour SL**: Ils n'ont plus à reflechir !
